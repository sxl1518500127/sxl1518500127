...
@section('css')
    ...
    <link rel="stylesheet" href="/h/homes//common/css/checkout.min.css" />
                               ...
                               @foreach($value as $k=>$v)
                                <li class="clearfix">
                                    <div class="col col-img">
                                        <img src="/uploads/{{$v->waresimgpath}}" width="30" height="30"></div>
                                    <div class="col col-name">
                                        <a href="//item.mi.com/1161000034.html" target="_blank" data-stat-id="5df49956c521d07e">{{$v->waresname}}</a>
                                    </div>
                                    <div class="col col-price">{{$v->spec}}元 x {{$v->count}}</div>
                                    <div class="col col-status">
                                        
                                        {{$v->warespec}}
                                    </div>
                                    <div class="col col-total">{{$v->spec*$v->count}}元</div>
                                </li>
                               @endforeach
                           @endforeach
                        </ul>
...
<script src="/h/homes/common/myjs/fnmodel.js"></script>    
<script src="/h/homes/common/myjs/order.js"></script>       
@endsection