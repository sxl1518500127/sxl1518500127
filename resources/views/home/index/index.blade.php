...
@section('content')
   <div class="header-nav">
        <ul class="nav-list J_navMainList clearfix">
            ...
            <!-- start banner_y -->
                <div style="  position: absolute; z-index:1000; left:340px;" class="banner_y center">
                    <div class="nav">
                        <ul>
                            @foreach($data as $k=>$v)
                            <li>
                                                            ...
                                                            @foreach($san as $kkkk => $sano)
                                                                <div style="width:230px;border:1px solid pink;">
                                                                    ...
                                                                    <div class="xuangou_right fr">
                                                                        <a href="/detail/{{ $sano->id }}" >选购</a></div>
                                                                    <div class="clear"></div>
            ...
            <div class="xm-plain-box">
                ...
                <div class="box-bd">
                    ...
                    <!--这里遍历开始 -->
                        ...
                        <li class="rainbow-item">
                            <h3 class="title">
                                <a href="/lists" target="_blank"><p class="price" style=" margin-top: 100px; font-size: 25px;">更多....</p></a>
                            </h3>
